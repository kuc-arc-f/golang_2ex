...
func main() {
	...
	http.HandleFunc("/api/list", handler.ListTodosHandler)
	http.HandleFunc("/api/create", handler.CreateTodoHandler)
	http.HandleFunc("/api/delete", handler.DeleteTodoHandler)
	http.HandleFunc("/api/update", handler.UpdateTodoHandler)
    http.HandleFunc("/todo_download", handler.TodoDownloadHandler)
